...
import { AppIcon, AppScreen, Card } from "../../shared/ui";
...
/**
 * Perfil tab: a month calendar of active days. Tap a day to see that day's
 * activities; tap one to open its detail.
 */
